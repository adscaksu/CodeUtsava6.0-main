  ...
  return (
    ...
    >
      <div className="codeutsava__team-body">
        ...
        <div className="codeutsava__team-title">Overall Lead</div>
        ...
        <div className="codeutsava__team-title">Domain Leads</div>
        <div className="codeutsava__team-members">
        ...
        <div className="codeutsava__team-title">Team Members</div>
        <div className="codeutsava__team-members">
