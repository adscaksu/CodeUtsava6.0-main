      ...
      <div className="codeutsava__section2-body">
        ...
        <div className="codeutsava__section2-menu">
          ...
          <div className="codeutsava__section2-content">
            <span style={{ color: "#38b6ff" }}>ThrillX 1.0</span> is an event
            being organized by AKS Developer Student Club, the Official Coding
            Club of AKS University. It aims to foster and nurture invigorating
            ...
            including the Hackathon ThrillX. Students from CS Department of AKS University
