...
import NIT from "../../assets/images/AKS.png";
import tcpName from "../../assets/images/tcp.png";
import codeutsava from "../../assets/images/cover.jpeg";
    ...
    <div className="codeutsava__footer" id="contactus">
      <div className="codeutsava__footer-container1">
        ...
        <div className="codeutsava__footer-social-container">
          <div className="codeutsava__footer-social-links-container">
            ...
            <a
              target="_blank"
              href="https://www.instagram.com/adsc_aksu/"
            >
              <svg
                fill="#999"
                width="32"
            ...
            <a target="_blank" href="https://github.com/adscaksu">
              <svg
                fill="#999"
                width="32"
                height="32"
            ...
            <a
              target="_blank"
              href="https://www.linkedin.com/in/adsc-aks-964453291/"
            >
              <svg
                fill="#999"
                width="32"
          ...
          <div className="codeutsava__footer-container2-left-content">
            ...
            <div className="codeutsava__footer-container2-left-text">
              ...
              <p>
                ...
                technology. For about a decade we have been doing it with
                sincerity and commitment at AKS University.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="codeutsava__footer-container3">
        <div className="codeutsava__footer-social-team">
          Architected with ❤️ by Team ADSC
        </div>
        ...
        <div className="codeutsava__footer-social-map">
          <a
            target="_blank"
            href="https://www.google.com/maps/place/AKS+University/@24.5683204,80.7904946,655m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3983808bffcf9267:0xe641037c3f5020c4!8m2!3d24.5683204!4d80.7930695!16s%2Fm%2F0hr8927?entry=ttu&g_ep=EgoyMDI0MDkwMy4wIKXMDSoASAFQAw%3D%3D"
          >
            <svg
              fill="#900"
              height="20"
